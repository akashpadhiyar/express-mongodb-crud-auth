...
router.get('/display-table', function (req, res, next) {
  UsersModel.find().then(function (db_users_array) {
...
router.get('/show/:id', function (req, res) {
  ...
  UsersModel.findById(req.params.id).then(function (db_users_array) {
    console.log(db_users_array);
...
router.get('/delete/:id', function (req, res) {
  UsersModel.findOneAndDelete(req.params.id).then(function (mydata) {
...
router.post('/login', function (req, res, next) {
  ...
  console.log(req.body);
  UsersModel.findOne({ "user_email": email }).then(function (db_users_array) {
...
router.post('/change-password', function (req, res, next) {
  ...
  UsersModel.findOne({ "user_email": myemail }).then(function ( db_users_array) {
      ...
      if (opass == db_users_array.user_password) {
        if (opass == npass) {
          ...
          if (npass == cpass) {
            UsersModel.findOneAndUpdate({ "user_email": myemail }, { $set: { "user_password": npass } }).then(function () {
